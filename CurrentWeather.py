...
button = tk.Button(frame, text="Go!", font=('Helvetica', 16), command=lambda: get_weather(entry.get()))
...
label = tk.Label(lower_frame, font=('Helvetica', 16), anchor='nw', justify='left', bd=10)
